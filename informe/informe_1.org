...
* Descripción del problema
  ...
  Dada la masividad de los datos generados actualmente, es necesario
  contar con herramientas automatizadas que permitan seleccionar
  contenido relevante, útil y veraz para los usuarios y/o consumidores
  de este contenido.\\
