...
* Descripción del problema
  ...
  /contenido/) de manera automática que sea no sólo /relevante/, sino
  también /útil/ y veraz para los usuarios, validando la correctitud
...
** Creación de una interfaz para visualizar y evaluar los resultados mediante un grupo de prueba
    ...
    Presentar los resultados obtenidos mediante una interfaz simple y
    usable, de forma de ver el contenido multimedia más importante a
    partir de un conjunto de eventos. Mediante un pequeño conjunto de
    usuarios, evaluar y validar los resultados obtenidos.
